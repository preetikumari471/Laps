	...
	public int addApplicationDetails(LoanApplicationBean loanApplication) {
		...
		try {
			...
			preparedstatement.setString(6,
					loanApplication.getGuaranteeCoverString());
			preparedstatement
					.setDouble(7, loanApplication.getMarktValOfCover());
			...
			preparedstatement = conn
					.prepareStatement(IQueryMapper.APPLICATIONID_QUERY_SEQUENCE);
			...
			/*
			 * if(queryResult==0) { logger.error("Insertion failed "); throw new
			 * DonorException("Inserting donor details failed ");
			 * 
			 * } else { logger.info("Donor details added successfully:"); return
			 * donorId; }
			 * 
			 * } catch(SQLException sqlException) {
			 * logger.error(sqlException.getMessage()); throw new
			 * DonorException("Tehnical problem occured refer log"); }
			 */
			 ...
			 * catch (SQLException sqlException) {
			 * logger.error(sqlException.getMessage()); throw new
			 * DonorException("Error in closing db connection");
			 * 
			 * }
			 */
