...
public class LoanApprovalDepartmentDaoImpl implements ILoanApprovalDepartmentDao {
	...
	public ArrayList<LoanApplicationBean> viewSpecificList(String program) {
		...
		try {
			preparedstatement=conn.prepareStatement(IQueryMapper.RETRIEVE_LOAN_SPECIFIC_APPLICATIONS);
