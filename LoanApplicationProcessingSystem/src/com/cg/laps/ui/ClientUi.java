...
public class ClientUi {
					...
					case 1:
						...
						while (input.equalsIgnoreCase("Y")) {
							if (loanProcessingService.display() != null) {
								...
								System.out.println();
								System.out
										.println("Succesfully applied for loan!!!");
	...
	// to add data for new loan programs to be added
	...
	// add data for the customer details
	...
	// adding data to the loan application form
